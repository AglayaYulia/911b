"""
 ...
 Номер карты замаскирован
 и отображается в формате XXXX XX** **** XXXX.
 Т. е. видны первые 6 цифр и последние 4, номер разбит по блокам
...
Это может быть строка типа
Visa Platinum 7000 7922 8960 6361, или
Maestro 7000 7922 8960 6361, или
...
Обратите внимание на то, что функции для маскировки уже реализованы. Переиспользуйте код,
который уже написан в проекте, а не дублируйте его.
...
11.07.2018.
Требования к названию функций:
Функция общей маскировки карты и счета называется mask_account_card.
Функция преобразования даты называется get_data.
"""